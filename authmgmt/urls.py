...
urlpatterns = [
    ...
    path('password_reset/done', auth_views.PasswordResetDoneView, { 'template_name': 'password_reset_done.html'}, name='password_reset_done'),
    path('password_reset', auth_views.PasswordResetView, { 'template_name': 'password_reset_form.html',
                                                        'extra_email_context': { 'domain': 'ezaws.delamarche.com', 'site_name': 'EZAws' }}, name='password_reset'),
    path('reset/<uidb64>/<token>', auth_views.PasswordResetConfirmView, { 'template_name': 'password_reset_confirm.html', }, name='password_reset_confirm'),
    path('reset/done', auth_views.PasswordResetCompleteView, { 'template_name': 'password_reset_complete.html', }, name='password_reset_complete'),
